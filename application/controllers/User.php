...
class User extends CI_Controller {
	...
	function feed($starting_point = null)
	{
		...
		// Get the user feed
		$data['user_feed'] = $this->instagram_api->get_user_feed(null,$starting_point);
	...
	function recent($user_id = FALSE, $starting_point = null)
	{
		...
		$data['user_recent_data'] = $this->instagram_api->get_user_recent($user_id, $starting_point);
	...
	function download($user_id = FALSE, $starting_point = null)
	{
		...
		$data['main_view'] = 'user_recent_download';
		$this->load->vars($data);
		
		$this->load->view('download_template');
	}
	
	function logout($user_id = FALSE)
	{
